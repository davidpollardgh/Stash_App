...
<body>
	...
	<h2 class=subtitle>Add to your Stash:</h2>
	<br>
	<br>
	<form:form action="/stashes/new" method="POST" modelAttribute="stash">
		...
		<br>
		<div class="text_center">			
			<input class="bg_green col_white1" type="submit" value="Add" />
		</div>
		<br>
		<br>
		<div class="text_center">
			<a class="col_white2" href="/home">cancel and return to your stuff</a>
		</div>	
	</form:form>
	</div>
</body>
